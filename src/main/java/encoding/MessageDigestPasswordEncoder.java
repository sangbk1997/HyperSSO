...
public class MessageDigestPasswordEncoder extends BaseDigestPasswordEncoder {
    ...
    public boolean isPasswordValid(String encPass, String rawPass, Object salt) {
        ...
        return encoding.PasswordEncoderUtils.equals(pass1, pass2);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hyperPasswordEncoder.encodePassword("12345", "abc"));
        System.out.println(hyperPasswordEncoder.encodePassword("root", "abc"));
    }
}
